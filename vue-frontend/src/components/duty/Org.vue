    ...
    <div class="content">
        <div class="top">
         ...
         <el-table
            ...
            :height="460"
            >
            <el-table-column prop="name" label="值班组织"></el-table-column>
            <el-table-column prop="principal" label="负责人"></el-table-column>
            <el-table-column prop="phone" label="手机号码"></el-table-column>
            <el-table-column prop="desc" label="描述" width="540"></el-table-column>
...
export default {
    data(){
        return {
            searchKey: '',
            tableData: [
                {name: '生产安全部', principal: '负责人', phone: '13100000000', desc: '描述', creator: 'admin', createDate: '2020-10-01 00:00:00'},
            ],
            dialogTitle: '添加',
            dialogVisible: false,
            dialogForm: {
